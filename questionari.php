...
require("codigo/conecta_sql.php");
		...
		$consulta = "SELECT * FROM juguesca_vst_questionari WHERE IdColla ='".$_SESSION['user_id']."' and DataActivacio <'".getdate()."'";
...
<script type="text/javascript" ><!--fonts de google-->
  ...
  (function() {
	...
	<title>La Juguesca - Subconcient</title>	
	</head>
	<body>
<div id="content" >
	...
	<!--CONTENIDOR-->	
		<div id="info_subconcient" >
			<p class="parrafo" >
				Has descobert la prova subconcient, per saber si esteu atents a TOT el que succeeix a la Juguesca, després d'algunes proves de la juguesca d'aquest any, aniran apareixent petits formularis 
				amb alguna pregunta sobre coses que han succeit durant la prova.
	...
	<?php
		while($row = $result -> fetch_assoc())
		{
			...
			$Respost = $row ["Respost"];			
		?>
		<div class="questions" id="questionari<?php echo $IDQ ?>">
			<div class="row">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Questionari</h5>
